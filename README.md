...
BotDevs is a reverse job board for **all** AI developers, with a focus on Diversity, Equity, Inclusion, and Belonging.
...
All code and documentation are copyright 2023 Joe Masilotti and Duncan Miller [under the MIT license](LICENSE).

All other resources including, but not limited to, images, copy, and branding, are copyright 2023 Duncan Miller and used by permission for this project only.

## Open source support

BotDevs uses a free or discounted open-source plan from the following companies. Thank you for the support!
